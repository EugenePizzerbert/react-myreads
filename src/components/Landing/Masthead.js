    ...
    <div className="masthead-container py-5">
      <div className="container">
        <div className="row row-no-gutter">
          <div className="col-md-7 all-light text-left align-self-center">
            <h4 className="font__family-montserrat mt-60 font__size-28 line__height-32 text-uppercase highlight-underline">
              <span
            ...
            <div className="mt-20 text-center text-md-left mb-20">
              <Link
                to="bookcase"
          ...
          <div className="col-md-4">
            <div className="text-center">
              <img src={imgDelimiterPhone} alt="alt" />
            </div>
          </div>
        </div>
      </div>
